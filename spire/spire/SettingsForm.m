...
- (NSArray *)fields
{
    return @[
             ...
             @{FXFormFieldKey: @"email", FXFormFieldDefaultValue:@"blah@blah.com", FXFormFieldHeader: @"Account"},
...
//               FXFormFieldOptions: @[@"password", @"repeatPassword"]},
             ...
             @{FXFormFieldKey: @"about", FXFormFieldType: FXFormFieldTypeLongText, FXFormFieldDefaultValue: @"Grab description from parse and insert here"},
